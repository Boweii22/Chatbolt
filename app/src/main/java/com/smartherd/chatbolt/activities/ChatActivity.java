...
import com.smartherd.chatbolt.adapters.ChatAdapter;
import com.smartherd.chatbolt.databinding.ActivityChatBinding;
...
//        setContentView(R.layout.activity_chat);
    ...
    private void sendMessage() {
        ...
        if(conversionId != null){
            updateConverison(binding.inputMessage.getText().toString());
        }else{
    ...
    private void updateConverison(String message){
